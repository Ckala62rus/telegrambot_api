                    ...
                    <form @submit.prevent="createOrganization">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label>Name backup tool type <span class="text-danger">*</span></label>
                                <input
                                    type="text"
                                    class="form-control"
                                ...
                                />
                                <div class="invalid-feedback">Name backup tool type, is required!</div>
                            </div>
                            <div class="form-group">
...
export default {
    ...
    methods: {
        createOrganization() {
            ...
            axios.post('/admin/backup-tools', this.form)
                .then(res => {
                    if (res.status === 201){
                        this.$notify({
